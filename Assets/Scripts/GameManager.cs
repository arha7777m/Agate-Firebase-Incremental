...
public class GameManager : MonoBehaviour
{
    ...
    private void CollectPerSecond()
    {
        ...
        AutoCollectInfo.text = $"AUTO COLLECT: { output.ToString("F1") } / DETIK";
    ...
    public void AddGold(double value)
    {
        ...
        GoldInfo.text = $"Tabunganmu: { UserDataManager.Progress.Gold.ToString("0") }";
    ...
    public void CollectByTap(Vector3 tapPosition, Transform parent)
    {
        ...
        CoinIcon.transform.localScale = Vector3.one * 1.25f;
    ...
    {
        GameObject[] resouces;
        resouces = GameObject.FindGameObjectsWithTag("Resource");
        foreach (ResourceController resource in _activeResources)
        {
            resource.LockedResource();
            Destroy(resource.gameObject,1f);
        }
        Invoke("AddAllResources", 5f);
    }
}
